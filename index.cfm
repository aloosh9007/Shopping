				...
				<div class="category-nav">
					...
					<cfset i = 1>
						...
						<li class="dropdown side-dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><cfoutput>#dptmenu.dptname#</cfoutput><i class="fa fa-angle-right"></i></a>
							<div class="custom-menu">
								<div class="row">
									<div class="col-md-4">
										<ul class="list-links">
											<cfquery name="getsub">
select * from subdepartment where departmentid =  "#dptmenu['departmentid'][i]#"
</cfquery>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<!-- /banner -->
<cfset itemonsale = application.products.saleitems() />
				<!-- Product Slick -->
				<div class="col-md-9 col-sm-6 col-xs-6">
					<div class="row">
						<div id="product-slick-1" class="product-slick">
<cfset counter = 1>
<cfoutput query="itemonsale">
							<!-- Product Single -->
							<div class="product product-single">
								<div class="product-thumb">
									<div class="product-label">
										<cfif #dateDiff('d', created, now())# lt 20>
											<span>New</span>
											</cfif>
...
<div id="snackbaradd">item added</div>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						<h2 class="title">Featured and Best Sellers</h2>
						<div class="pull-right">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single product-hot">
						...
						<div class="product-body">
							...
							<h2 class="product-name"><a href="#">This is a static product</a></h2>
							<div class="product-btns">
								<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
				...
				<!-- /Product Single -->
<cfset bestseller = application.products.bestseller() />
				<!-- Product Slick -->
				<div class="col-md-9 col-sm-6 col-xs-6">
					<div class="row">
...
<cfoutput query="bestseller">							
	...
	<a href="product-page.cfm?itemid=#itemid#"><button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button></a>
								...
								<div class="product-body">
									...
									<h2 class="product-name"><a href="">#itemname# #shortdescription#</a></h2>
									<div class="product-btns">
										<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
